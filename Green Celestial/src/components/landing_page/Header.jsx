        ...
        <>
            <header>
                ...
                <div className="nav_sec" style={{ left: slider }}>
                    <ul className="mob_ul">
                        <li onClick={handleSlider}><Link to="/">Home</Link></li>
                        <li onClick={handleSlider}><Link to="/about">About Us</Link></li>
                        <li onClick={handleSlider}><Link to="/blogs">Blogs</Link></li>
                        <li onClick={handleSlider}><Link to="/exp">Experiences</Link></li>
                        <li onClick={handleSlider}><Link to="/contact">Contact Us</Link></li>
                    </ul>
                </div>
            </header>
        </>
